      ...
      return WillPopWidget(
        ...
        child: SafeArea(
          child: Scaffold(
            ...
            body:
                // controller.noInternet?NoDataOrInternetScreen(isNoInternet: true,imageHeight: .7,paddingTop: 5,onChanged: (b){
                //   if(b){
