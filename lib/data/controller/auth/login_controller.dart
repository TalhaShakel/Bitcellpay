  ...
  void checkAndGotoNextStep(LoginResponseModel responseModel) async {
    ...
    if (needSmsVerification == false &&
      ...
      if (isProfileCompleteEnable) {
        ...
        String pin = loginRepo.apiClient.sharedPreferences
                .getString(SharedPreferenceHelper.screenLockPin) ??
            '';
    ...
    if (model.statusCode == 200) {
      ...
      if (loginModel.status.toString().toLowerCase() ==
        ...
        CustomSnackbar.showCustomSnackbar(errorList: [
          loginModel.message?.error?.toString() ?? MyStrings.loginFailedTryAgain
        ], msg: [], isError: true);
        changeIsLoading();
        return;
      }
