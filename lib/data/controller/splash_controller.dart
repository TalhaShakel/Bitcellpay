...
class SplashController extends GetxController {
  ...
  //     print("Initial message retrieved");

  //     if (initialMessage != null && initialMessage.data.isNotEmpty) {
  //       print("Initial message is not null and data is not empty");
  ...
  //         print("Navigating to trade details screen with tradeId: $tradeId");
  ...
  //       return;
  //     } else {
  //       print("Initial message is null or data is empty");
